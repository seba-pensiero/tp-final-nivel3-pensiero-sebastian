...
namespace negocio
{
    public class ArticuloNegocio
    {
        ...
        public List<Articulos> listarConSp()
        {
            ...
            try
            {
                //string consulta = "select Codigo, Nombre, A.Descripcion, IdMarca, IdCategoria, ImagenUrl, Precio, C.Id IdCat, C.Descripcion DescCat, M.Id IdMarca, M.Descripcion DescMarca, A.Id from ARTICULOS A, CATEGORIAS C, MARCAS M where C.Id = A.IdCategoria and M.Id = A.IdMarca";
